...
| 2026-07-13 | #13 / #14 | Define the manual authoring and review workflow | Workflow specification; two end-to-end source lifecycles; 4 published example profiles added to validation | Gate 4 implementation ready for independent CI | Implement deterministic semantic profile comparison |
