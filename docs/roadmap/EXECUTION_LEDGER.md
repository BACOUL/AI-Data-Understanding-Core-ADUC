...
| 2026-07-13 | #9 / #10 | Implement the semantic mapping profile schema | Draft 2020-12 schema; 4 valid and 10 invalid fixtures; local validator passed | Gate 2 implementation ready for independent CI | Build user-facing semantic validator and error catalogue |
