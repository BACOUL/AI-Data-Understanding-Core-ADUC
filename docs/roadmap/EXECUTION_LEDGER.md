...
| 2026-07-13 | #11 / #12 | Build the user-facing semantic validator | Text/JSON CLI; stable error codes; 8 local tests covering semantic rules and exit codes | Gate 3 implementation ready for independent CI | Define manual authoring and review workflow |
